...
//                if (!backFile.exists() || backFile.length() == 0.toLong()) {
...
//                activity!!.grantUriPermission(appName, backgroundVideoFile, Intent.FLAG_GRANT_READ_URI_PERMISSION)
//
...
//                } else {
//                    result.success("error: No app found to handle this intent")
//                }
//
//                return
//            }
